/**
 * test_warp_shuffle.cu — Legacy correctness test for WarpShuffle::block_scan
 *
...
#include <cmath>
#include <vector>
#include "../warp_shuffle.cu"   // active runtime file; this legacy test is kept for reference only
